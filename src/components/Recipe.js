...
export default function Recipe(props) {
    ...
    const { handleRecipeDelete, handleSelectedRecipeId } = useContext(RecipeControllerContext);
    ...
    return (
        <div className="recipe">
            <div className="recipe__header">
                ...
                <div>
                    <button 
                        ...
                        onClick={() => {handleSelectedRecipeId(id)}}
                    >Edit</button>
                    <button 
            ...
            <div className="recipe__row">
                <span className="recipe__label">Cook Time: </span><span className="recipe__value">{cookTime}</span>
            </div>
            <div className="recipe__row">
